/* =========================================================
   DeepShield AI
   app.js v0.6
   Upload + Drag & Drop + Forensics + AI Detection
   ========================================================= */
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    console.log("DeepShield AI started.");
    ...
    /*
       Load AI separately.
       Upload functionality does NOT depend on AI loading.
    */
    loadAIModel();
...
function setupFileUpload() {
    ...
    /*
       Clicking anywhere inside dropZone opens file picker.
       The label "for=fileInput" also supports this.
    */
    ...
    if (dropZone) {
        ...
        dropZone.addEventListener("click", (event) => {
            ...
            /*
               Prevent duplicate behavior when clicking
               the input itself.
            */
...
function setupDragAndDrop() {
    ...
    dropZone.addEventListener("dragleave", (event) => {
        ...
        /*
           Only remove class when leaving actual drop zone.
        */
...
function handleSelectedFile(file) {
    ...
    */
    ...
    if (fileSelected) {
        ...
        fileSelected.innerHTML = `
            <strong>Selected Media</strong><br>
    ...
    */
    ...
    if (scanButton) {
        ...
        scanButton.textContent = "🧠 Start AI Analysis";
...
function validateFile(file) {
    ...
    if (file.size > CONFIG.MAX_FILE_SIZE) {
        ...
        return {
            valid: false,
            message: "File is larger than 200 MB."
        };
    ...
    /*
       Some browsers may return empty MIME type.
       In that case inspect extension.
    */

    if (!supported && !isSupportedExtension(file.name)) {
...
async function loadAIModel() {
    ...
    if (aiLoading || aiClassifier) {
        return;
    }

    aiLoading = true;

    console.log("Loading DeepShield AI model...");
    ...
    try {
        ...
        /*
           ...
           This prevents an import failure from breaking
...
async function analyzeFile(file) {
    ...
    */
    ...
    if (aiConfidence) {
        aiConfidence.textContent = "Analyzing...";
    }
...
async function runImageForensics(file) {
    ...
    for (
        ...
        for (
            ...
            /*
               Simple horizontal edge estimation
            */

            if (x + sampleStep < width) {

                const nextIndex =
                    (y * width + x + sampleStep) * 4;
...
function calculateForensicScore(data) {
...
function displayResults(
    ...
    */
    ...
    if (riskLevel) {
        ...
        if (aiResult?.deepfakeProbability != null) {
    ...
    if (forensicDetails) {
        ...
        if (aiResult) {
            ...
            aiText =
                `
                AI Classification:
                ${escapeHTML(aiResult.label)}<br>

                AI Confidence:
                ${aiResult.confidence}%<br>

                ${
                    aiResult.deepfakeProbability != null
                        ? `Deepfake Probability:
                           ${aiResult.deepfakeProbability}%<br>`
                        : ""
                }
...
function classifyCompression(value) {
